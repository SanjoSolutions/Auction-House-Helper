...
function AuctionHouseHelperConfigSellingShortcutsFrameMixin:OnShow()
  ...
  self.CancelShortcut:SetValue(AuctionHouseHelper.Config.Get(AuctionHouseHelper.Config.Options.SELLING_CANCEL_SHORTCUT))
  self.BuyShortcut:SetValue(AuctionHouseHelper.Config.Get(AuctionHouseHelper.Config.Options.SELLING_BUY_SHORTCUT))
...
function AuctionHouseHelperConfigSellingShortcutsFrameMixin:Save()
  ...
  AuctionHouseHelper.Config.Set(AuctionHouseHelper.Config.Options.SELLING_CANCEL_SHORTCUT, self.CancelShortcut:GetValue())
  AuctionHouseHelper.Config.Set(AuctionHouseHelper.Config.Options.SELLING_BUY_SHORTCUT, self.BuyShortcut:GetValue())
